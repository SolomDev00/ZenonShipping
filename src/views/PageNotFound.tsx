      ...
      <div className="px-4 lg:py-12">
        <div className="lg:gap-4 lg:flex">
          <div className="flex flex-col items-center justify-center md:py-24 lg:py-32">
            ...
            <p className="mb-2 text-2xl font-bold text-center md:text-3xl text-black">
            ...
            <Link
              to={"/"}
              className="inline-block bg-primary p-2 text-black hover:bg-primary/80 rounded-md duration-300"
              reloadDocument
            >
              Go Home
            </Link>
